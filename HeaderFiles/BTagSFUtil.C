...
inline BTagSFUtil::BTagSFUtil(TString BTagAlgorithm, TString DataPeriod, TString FastSimDataset, int Seed) {
...
inline BTagSFUtil::~BTagSFUtil() {

  delete rand_;

}

inline float BTagSFUtil::ScaleFactorB(float JetPt, int SystematicFlag) {
...
inline float BTagSFUtil::ScaleFactorLight(float JetPt, float JetEta, int SystematicFlag) {
...
inline float BTagSFUtil::ScaleFactorJet(int JetFlavor, float JetPt, float JetEta, int SystematicFlag) {
...
inline float BTagSFUtil::FastSimCorrectionFactor(int JetFlavor, float JetPt, float JetEta, int FastSimSystematic) {

  float CF = 1.;
 
  if (JetPt<FastSimPtBinEdge[0]) { cout << "CF is not available for jet pt<30 GeV" << endl; return -1.; }
...
inline float BTagSFUtil::JetTagEfficiency(int JetFlavor, float JetPt, float JetEta) {
...
inline bool BTagSFUtil::IsTagged(float JetDiscriminant, int JetFlavor, float JetPt, float JetEta, int SystematicFlag, int FastSimSystematic) {
...
inline bool BTagSFUtil::IsTagged(float JetDiscriminant, int JetFlavor, float JetPt, float JetEta, int SystematicFlag, int FastSimSystematic, bool beVerbose) {
